-- ============================================================================
-- MIGRATION 089b: FIX INVENTORY REDUCTION ON SALES (CORRECTED)
-- ============================================================================
-- Issue: Previous migration failed because total_cost is a generated column
-- Fix: Remove total_cost from INSERT statements
-- ============================================================================
...
BEGIN
    RAISE NOTICE '========================================';
    RAISE NOTICE 'CORRECTED INVENTORY REDUCTION FIX';
    RAISE NOTICE '========================================';
    RAISE NOTICE 'Fixing: Generated column total_cost issue';
    RAISE NOTICE '';
END;
$$;

-- ============================================================================
-- PART 1: UPDATE THE MAIN FUNCTION (CORRECT total_cost issue)
-- ============================================================================
...
BEGIN
    ...
    -- FIX 2: CREATE INVENTORY TRANSACTION RECORDS (CORRECTED - no total_cost)
    INSERT INTO inventory_transactions (
        ...
        quantity,
        unit_cost,
        -- total_cost is generated, don't include it
        reference_type,
        reference_id,
        notes,
        created_by,
...
-- ============================================================================
-- PART 2: FIX HISTORICAL DATA (CORRECTED - no total_cost)
-- ============================================================================
DO $$
DECLARE
...
BEGIN
    ...
    -- Create missing inventory transactions (CORRECTED - no total_cost)
    INSERT INTO inventory_transactions (
        id,
        business_id,
        inventory_item_id,
    ...
    RAISE NOTICE 'Created % missing inventory transactions', v_transactions_created;
...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE '✅ CORRECTED FIX APPLIED';
    RAISE NOTICE '   Fixed: Generated column total_cost';
...
SELECT 
    ...
    current_stock,
    (SELECT COUNT(*) FROM inventory_transactions WHERE inventory_item_id = id) as inventory_tx_count
FROM inventory_items 
