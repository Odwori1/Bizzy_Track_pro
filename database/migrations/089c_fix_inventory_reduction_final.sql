-- ============================================================================
-- MIGRATION 089c: FIX INVENTORY REDUCTION ON SALES (FINAL)
-- ============================================================================
-- Issue: transaction_type 'sale_out' not allowed, should be 'sale'
-- Allowed values: 'purchase', 'sale', 'adjustment', 'transfer', 'write_off'
-- ============================================================================
...
BEGIN
    RAISE NOTICE '========================================';
    RAISE NOTICE 'FINAL INVENTORY REDUCTION FIX';
    RAISE NOTICE '========================================';
    RAISE NOTICE 'Fixing: transaction_type should be "sale" not "sale_out"';
    RAISE NOTICE '';
END;
$$;

-- ============================================================================
-- PART 1: UPDATE THE FUNCTION (FIX transaction_type)
-- ============================================================================
...
BEGIN
    ...
    -- FIX 2: CREATE INVENTORY TRANSACTION RECORDS (FIXED transaction_type)
    INSERT INTO inventory_transactions (
        id,
        business_id,
        inventory_item_id,
        transaction_type,          -- MUST be 'sale' not 'sale_out'
        quantity,
        unit_cost,
        reference_type,
        reference_id,
...
-- ============================================================================
-- PART 2: FIX HISTORICAL DATA (FIXED transaction_type)
-- ============================================================================
DO $$
DECLARE
...
BEGIN
    ...
    -- Create missing inventory transactions (FIXED transaction_type)
    INSERT INTO inventory_transactions (
        id,
        business_id,
        inventory_item_id,
...
BEGIN
    ...
    RAISE NOTICE '========================================';
    RAISE NOTICE '✅ Function updated with correct transaction_type: "sale"';
    RAISE NOTICE '✅ Historical data fix uses correct transaction_type: "sale"';
    RAISE NOTICE '';
END;
$$;
