-- Migration: Create function to override/correct depreciation
-- File: 503_create_depreciation_override_function.sql
...
BEGIN
    ...
    -- Update the depreciation record with override amount
    UPDATE asset_depreciations
    SET depreciation_amount = p_override_amount,
        updated_at = NOW(),
        notes = COALESCE(notes, '') || ' | Override applied: ' || p_reason
