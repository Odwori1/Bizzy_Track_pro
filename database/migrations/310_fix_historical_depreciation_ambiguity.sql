-- Migration 310: Fix historical depreciation function ambiguity
-- Date: 2026-01-12
-- Purpose: Fix ambiguous column references in historical depreciation functions

BEGIN;

-- Drop and recreate calculate_historical_depreciation function
...
-- Drop and recreate post_historical_depreciation function
...
-- Also fix the enhanced_asset_register view to show correct current_book_value
...
SELECT
    ...
    -- Calculate net book value correctly
