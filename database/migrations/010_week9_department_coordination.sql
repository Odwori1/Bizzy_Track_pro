-- ============================================================================
-- WEEK 9: DEPARTMENT COORDINATION MIGRATION
-- ============================================================================

-- 1. Departments table with hierarchy support
CREATE TABLE departments (
    ...
    -- Ensure hierarchy stays within same business
    CONSTRAINT fk_department_same_business 
        FOREIGN KEY (business_id, parent_department_id) 
        REFERENCES departments(business_id, id)
);

-- 2. Department roles and permission templates
...
-- 3. Job department assignments and workflow states
...
-- 4. Department workflow states and handoffs
...
-- 5. Department-specific billing rules and cost allocation
...
-- 6. Consolidated department billing entries
...
-- ============================================================================
-- DEFAULT DATA FOR NEW BUSINESSES (Following Week 8 Pattern)
-- ============================================================================

-- Note: Default departments will be created when a business is set up
-- through the business service, similar to how default categories are handled
