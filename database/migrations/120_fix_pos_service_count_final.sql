...
BEGIN
    RAISE NOTICE '========================================';
    RAISE NOTICE 'FIXING POS SERVICE COUNT - FINAL VERSION';
    RAISE NOTICE '========================================';
END;
$$;
...
BEGIN
    ...
    -- ✅ FIX: Count ALL items properly (products + services)
    SELECT 
    ...
    -- ✅ FIX: Calculate total COGS only from PRODUCTS (not services)
    ...
    -- ✅ FIX: Create appropriate description based on item types
...
-- ============================================================================
-- PART 2: SIMPLE MANUAL FIX FOR EXISTING DESCRIPTIONS
-- ============================================================================
DO $$
DECLARE
...
BEGIN
    RAISE NOTICE '';
    RAISE NOTICE 'Manually fixing existing wrong descriptions...';
    
    -- Fix SYS-000004 specifically (the service sale)
    UPDATE journal_entries je
    SET description = 'POS Sale: SYS-000004 (mobile_money, 1 service)'
    FROM pos_transactions pt
    WHERE je.business_id = 'ac7de9dd-7cc8-41c9-94f7-611a4ade5256'
        AND je.reference_type = 'pos_transaction'
        AND je.reference_id = pt.id::TEXT
        AND pt.transaction_number = 'SYS-000004'
        AND je.description LIKE '%0 items%';
