-- Migration 087: Fix race condition in ensure_business_has_complete_accounts()
-- Replaces WHERE NOT EXISTS with atomic ON CONFLICT DO NOTHING
...
BEGIN
    ...
    -- This prevents race conditions during business registration
