-- ============================================================================
-- MIGRATION 100: COMPLETE EXPENSE SYSTEM FIX
-- ============================================================================
...
BEGIN
    RAISE NOTICE '========================================';
    RAISE NOTICE 'COMPLETE EXPENSE SYSTEM FIX';
    RAISE NOTICE '========================================';
END;
$$;
...
-- The problem: 5200 renamed to "Rent" but mapping still uses it for "Salaries"
-- Solution: Add proper salary account (5206) and fix naming
...
BEGIN
    ...
    IF NEW.account_code IS NULL OR NEW.account_code = '' THEN
        ...
        RAISE NOTICE '✅ Auto-mapped category "%" to account code "%" (%)',
            NEW.name,
            v_mapped_code,
            (SELECT account_name FROM chart_of_accounts 
             WHERE business_id = NEW.business_id 
               AND account_code = v_mapped_code 
             LIMIT 1);
    ELSE
        RAISE NOTICE '✓ Category "%" using provided account code: %', 
            NEW.name, NEW.account_code;
    END IF;
